...
if play == 'yes':
    question_no += 1
    ques = input(f'\n{question_no}. what does CPU stand for? a. central processing unit b. center processing unit c. circle process unit.  ').lower()
    if ques == 'a' or 'central processing unit':
        score +=1
